...
func (*SecurityHandler) HandleApiKeyAuth(ctx context.Context, operationName string, t oas.ApiKeyAuth) (context.Context, error) {
	return ctx, nil
}

func (*SecurityHandler) HandleOAuth2(ctx context.Context, operationName string, t oas.OAuth2) (context.Context, error) {
	return ctx, nil
}

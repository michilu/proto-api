...
class ExampleServiceApi(object):
    ...
    def example_service_query(self, id, body, **kwargs):  # noqa: E501
        ...
        :param V1ExampleServiceQueryRequest body: (required)
    ...
    def example_service_query_with_http_info(self, id, body, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(V1ExampleServiceQueryResponse, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        return self.api_client.call_api(
            ...
            response_type='V1ExampleServiceQueryResponse',  # noqa: E501

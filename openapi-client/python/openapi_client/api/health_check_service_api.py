...
class HealthCheckServiceApi:
    ...
    @validate_arguments
    def health_check(self, **kwargs) -> V1HealthCheckServiceHealthCheckResponse:  # noqa: E501
    ...
    def health_check_with_http_info(self, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(V1HealthCheckServiceHealthCheckResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        _response_types_map = {
            '200': "V1HealthCheckServiceHealthCheckResponse",
        }

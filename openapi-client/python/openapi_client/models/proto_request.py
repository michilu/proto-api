...
class ProtoRequest(object):
    ...
    def __init__(self, id=None, local_vars_configuration=None):  # noqa: E501
        """ProtoRequest - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def id(self):
        """Gets the id of this ProtoRequest.  # noqa: E501


        :return: The id of this ProtoRequest.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ProtoRequest):
            return False

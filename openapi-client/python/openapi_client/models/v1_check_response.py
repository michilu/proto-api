...
class V1CheckResponse(BaseModel):
    ...
    V1CheckResponse
    """
    status: Optional[CheckResponseServingStatus] = None
    __properties = ["status"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1CheckResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1CheckResponse:
        """Create an instance of V1CheckResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V1CheckResponse.parse_obj(obj)

        _obj = V1CheckResponse.parse_obj({

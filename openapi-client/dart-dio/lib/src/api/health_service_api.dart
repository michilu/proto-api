...
class HealthServiceApi {
  ...
  const HealthServiceApi(this._dio, this._serializers);
  ...
  Future<Response<V1CheckResponse>> healthServiceCheck({ 
    ...
    V1CheckResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(V1CheckResponse),
      ) as V1CheckResponse;
    ...
    return Response<V1CheckResponse>(
      data: _responseData,

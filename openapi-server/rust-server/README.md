...
- API version: 1.0
- Build date: 2025-05-28T05:51:51.205440894Z[Etc/UTC]
...
```
cargo run --example client HealthServiceCheck
```
...
------------- | ------------- | -------------
[**ExampleService_Query**](docs/example_service_api.md#ExampleService_Query) | **POST** /v1/example/{id} | 
[**HealthService_Check**](docs/health_service_api.md#HealthService_Check) | **GET** /v1/healthCheck | 

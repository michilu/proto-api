...
// AllowedRpcCodeEnumValues is all the allowed values of RpcCode enum
...
// validRpcCodeEnumValue provides a map of RpcCodes for fast verification of use input
var validRpcCodeEnumValues = map[RpcCode]struct{}{
	"OK":                  {},
	"CANCELLED":           {},
	"UNKNOWN":             {},
	"INVALID_ARGUMENT":    {},
...
func NewRpcCodeFromValue(v string) (RpcCode, error) {
	...
	return "", fmt.Errorf("invalid value '%v' for RpcCode: valid values are %v", v, AllowedRpcCodeEnumValues)
}

// AssertRpcCodeRequired checks if the required fields are not zero-ed
func AssertRpcCodeRequired(obj RpcCode) error {
	return nil
}
